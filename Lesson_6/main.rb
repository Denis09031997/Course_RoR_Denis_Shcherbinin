  ...
  def create_station
    begin
      ...
      if station.valid?
        ...
        puts 'Ошибка при создании станции. Проверьте введенные данные.'
      end
  ...
  def create_train
    begin
      ...
      if train.valid?
        ...
        puts 'Ошибка при создании поезда. Проверьте введенные данные.'
      end
    rescue StandardError => e
      puts "Ошибка: #{e.message}"
      retry
  ...
  def create_route
    begin
      ...
      if route.valid?
        ...
        puts 'Ошибка при создании маршрута. Проверьте введенные данные.'
      end
    rescue StandardError => e
      puts "Ошибка: #{e.message}"
      retry
